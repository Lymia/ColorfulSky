...
(This list only includes the major mods that are interesting for players. It omits library mods and low-level utility mods that aren't too noticable to players.)
...
- [Ore Clumps](https://www.curseforge.com/minecraft/mc-mods/oreclumps)
